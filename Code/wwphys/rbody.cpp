...
#define RBODY_DEBUG_FILTER				(_stricmp(Model->Get_Name(),"V_GDI_ORCA_M") == 0) && (PhysicsSceneClass::Get_Instance()->Is_Debug_Display_Enabled())
...
{
	if (_stricmp(type_name,RigidBodyDefClass::Get_Type_Name()) == 0) {
		return true;
	} else {
