...
static BOOL WW_TreeView_SetCheckState(HWND hwndTreeView, HTREEITEM hItem, BOOL fCheck);
		...
		for (int index = 0; index < count; index ++) {
			...
			if (child_preset != NULL) {
				...
				if (new_item != NULL) {
					...
					//
					WW_TreeView_SetCheckState(m_TreeCtrl, new_item, true);
...
ParameterInheritanceDialogClass::Update_Tree_Entry_Check (HTREEITEM parent_item, bool checked)
{
	...
	//
	WW_TreeView_SetCheckState(m_TreeCtrl, parent_item, checked);
...
/////////////////////////////////////////////////////////////////////////////
//
// WW_TreeView_SetCheckState
//
/////////////////////////////////////////////////////////////////////////////
BOOL
WW_TreeView_SetCheckState(HWND hwndTreeView, HTREEITEM hItem, BOOL fCheck)
{
    TVITEM tvItem;
